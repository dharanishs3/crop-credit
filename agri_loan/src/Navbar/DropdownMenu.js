...
import { Send, Activity, Info, LogOut ,Percent} from 'react-feather';
      ...
      {isLoggedIn ? (
        <>
          ...
          <div className="drop-option">
            ...
            <div><button className="drop-buttons" onClick={handleLoanTracker}><Activity className="dropdown-icon" /> Loan Tracker</button></div>
            <div><button className="drop-buttons"  onClick={HandleEmiCalculator}><Percent className="dropdown-icon" /> EMI Calculator</button></div>
