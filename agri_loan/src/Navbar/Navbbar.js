...
export default function Navbar() {
  ...
  const [showApplyNowMenu, setShowApplyNowMenu] = useState(false); // State for Apply Now dropdown
  ...
  return (
    <div className='Nav-bar'>
      <div className="title-bar">
        <div><button className='main-button1' onClick={handlehome}><img className="icon-plant" src="plant.svg"/>Grow <span className="span-title"> Fund</span></button></div>
        ...
        {showApplyNowMenu && <ApplyNowMenu />} {/* Render Apply Now dropdown */}
        </div>
        
        <div><button className='main-button' onClick={handleLoanStatus}>Loan Status</button></div>
