...
import MovetoTop from './MovetoTop.js';
      ...
      <div className='home-background'>
        ...
        <div className='home-content'>
          <div className='caption'>
            <div><h1>"Plant Your Dreams with GrowFund  <br />Fast Financing for Your Agricultural Success!"</h1></div>
            <div><p>Need fast loan? Try GrowFund for your needs</p></div>
          </div>
